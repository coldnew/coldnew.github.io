...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12090_SHARP_){
if(clojure.string.starts_with_QMARK_(p1__12090_SHARP_,clojure.string.join.cljs$core$IFn$_invoke$arity$1(cljs.core.rest(cljs.core.re_find(regex,p1__12090_SHARP_))))){
return clojure.string.replace(p1__12090_SHARP_,regex,newval);
} else {
...
var args12091 = [];
var len__7511__auto___12094 = arguments.length;
var i__7512__auto___12095 = (0);
while(true){
if((i__7512__auto___12095 < len__7511__auto___12094)){
args12091.push((arguments[i__7512__auto___12095]));

var G__12096 = (i__7512__auto___12095 + (1));
i__7512__auto___12095 = G__12096;
continue;
} else {
}
break;
