#+TITLE: 替你的 eshell prompt 上色
#+DATE: <2013-11-13 Wed 22:18>
#+UPDATED: <2013-11-13 Wed 22:18>
#+ABBRLINK: 32c1fa12
#+OPTIONS: num:nil ^:nil
#+TAGS: emacs
#+LANGUAGE: zh-tw
#+ALIAS: blog/2013/11-13_1f0563/index.html
#+ALIAS: blog/2013/11/13_1f0563.html
...
- 預設的 terminal prompt 太醜
  ...
  身為 Gentoo Linux 的使用者，對於 shell prompt 的外觀是非常講究的，預設的 eshell
...
#+BEGIN_CENTER
[[file:替你的-eshell-prompt-上色/eshell-color-prompt.png]]
#+END_CENTER
