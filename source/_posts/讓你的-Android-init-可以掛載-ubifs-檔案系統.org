#+TITLE: 讓你的 Android init 可以掛載 UBIFS 檔案系統
#+DATE: <2014-01-11 Sat 10:08>
#+UPDATED: <2014-01-11 Sat 10:08>
#+ABBRLINK: 268537da
#+OPTIONS: num:nil ^:nil
#+TAGS: android, ubifs
#+LANGUAGE: zh-tw
#+ALIAS: blog/2014/01-11_andro/index.html
#+ALIAS: blog/2014/01/11_andro.html
...
請將 Linux Kernel 的 =include/mtd/ubi-user.h= 複製到 =init= 目錄裡面，注意到最好
...
由於我們增加了一些 ubifs 相關的函式，因此必須自己在 =init/util.c= 裡面加入相對應的實現。
